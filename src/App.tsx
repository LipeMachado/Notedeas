  ...
  return (
    <>
      <div className="min-h-screen p-8 text-neutral-50 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900">
        <div className="bg-gray-900/80 backdrop-blur-sm w-[1100px] mx-auto rounded-xl min-h-[630px] shadow-lg border border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]">
